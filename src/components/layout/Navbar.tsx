...
const Navbar: React.FC = () => {
  return (
    <div className="fixed top-0 left-64 z-40 w-[calc(100%-16rem)] bg-pink-100 shadow-sm px-6 py-4 flex items-center justify-between">
      {/* Left: Optional title */}
      {/* <h2 className="text-xl font-semibold text-gray-700">Counselor Registrations</h2> */}
